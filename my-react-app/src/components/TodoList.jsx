...
const TodoList = () => {
   ...
   const handleAddTodo = () => {
        // 전개 역할로 ...todoList 사용함 (기존 todoList가 가진 배열을 펼쳐고 뒤에 새로운 요소를 추가)
   ...
   const handleDeleteTodo = (index) => {
    ...
    // 필터는 새로운 배열을 반환하므로 직접 원본 배열을 복사할 필요 X
